...
Feature: Listing
    As a user
    I should be able to see the standard listing page and all the sections on all devices

    Scenario Outline: Verify a standard listing in <device> view
        Given I switch to "<device>" view
        When I am currently viewing "directory/furniture-and-interiors/cotswold-inout-furniture-16254"        
