const adsWidget = {
    ...
    ad_PolarBrandTopTeaser1_Desktop:
        '.brand-section .brand-section__featured .columns .row .teaser:nth-child(1) .ad--bottom-label [id^=ad-gpt-slot-]', // brand
    ...
    ad_PolarBrandTopTeaser6_Desktop:
        '.brand-section .brand-section__featured .columns .row .teaser:nth-child(6) .ad--bottom-label [id^=ad-gpt-slot-]', // brand
    ...
    ad_PolarLoadMore2_Desktop:
        '.repeatable-component .row:nth-child(2) .section__list article.teaser:nth-child(2) .ad--bottom-label [id^=ad-gpt-slot-]', // homepage, section
    ad_PolarLoadMore2_Mobile:
        '.repeatable-component .row:nth-child(2) .section__list article.teaser:nth-child(3) .ad--bottom-label [id^=ad-gpt-slot-]', // homepage, section
    ad_PolarLoadMore6_Desktop:
        '.repeatable-component .row:nth-child(2) .section__list article.teaser:nth-child(6) .ad--bottom-label [id^=ad-gpt-slot-]', // homepage, section
    ad_PolarLoadMore6_Mobile:
        '.repeatable-component .row:nth-child(2) .section__list article.teaser:nth-child(7) .ad--bottom-label [id^=ad-gpt-slot-]', // homepage, section
    ...
    ad_PolarRelatedContentInBody:
        '.content-body-container .content-body__related-content .feed-item:nth-child(1) .ad--bottom-label [id^=ad-gpt-slot-]', // gallery, article
    ad_PolarRelatedContentAfterSlide7:
        '.gallery__feed-item--ad:nth-child(9) .content-body__related-content .feed-item:nth-child(1) .ad--bottom-label [id^=ad-gpt-slot-]', // gallery
